...
** Functional Analysis
:PROPERTIES:
:EXPORT_FILE_NAME: ifa-notes
:END:
*** Inner Product Spaces
+ Motivation: Generalizing dot product and orthogonality to arbitrary vector spaces leading to innrer and complete inner product spaces  (Hilbert spaces).
+
