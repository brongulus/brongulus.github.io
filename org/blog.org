...
* TODO
1. Link to RSS feed
2. Create Tufte Theme for hugo that ACTUALLY works based on tufte css and the current tale theme
3. Open external links in new tab by default, unless it's meta-links.
* People I Idolize
+ Robert Endre Tarjan
+ Lars Ingebrigtsen
+ Gennady Korotkevich
