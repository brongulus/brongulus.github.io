...
(defvar svg-toggle-button
  "<button id='dark-mode-button' aria-label='Toggle Dark Mode'>
    <svg id='moon-icon' xmlns='http://www.w3.org/2000/svg' width='24' height='18' viewBox='0 0 20 20' fill='currentColor'>
      <path d='M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z'></path>
    </svg>
    <svg id='sun-icon' xmlns='http://www.w3.org/2000/svg' width='24' height='18' viewBox='0 0 20 20' fill='currentColor' style='display: none;'>
...
(defvar rss-svg
  "<a href='/rss.xml'>
    <button id='rss-button' aria-label='Get RSS feed'>
      <svg xmlns='http://www.w3.org/2000/svg' width='24' height='18' viewBox='0 0 448 512' fill='currentColor'>
